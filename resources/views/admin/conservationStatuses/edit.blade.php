...
<div class="container py-4">
    ...
    <h1 class="mb-2">Modifica Stato</h1>

    <form action="{{ route('admin.conservationStatuses.update', $conservationStatus) }}"
          method="POST"
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <input type="color"
                                ...
                                value="{{ old('color', $conservationStatus->color ?? config('zoodex.fallback_color')) }}">
                                <big>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description"
                                id="description"
                                rows="2"
                                class="form-control">{{ old('description', $conservationStatus->description) }}</textarea>
                    </div>
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('admin.conservationStatuses.show', $conservationStatus) }}" class="btn btn-secondary">
                Annulla
            </a>
        </div>
