...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-start mb-2 flex-wrap">
        ...
        <h1 class="mb-1">{{ $conservationStatus->name }}</h1>

        <div class="d-flex gap-2 flex-wrap">

            <a href="{{ route('admin.conservationStatuses.index') }}" class="btn btn-outline-secondary">
                <i class="bi bi-chevron-double-left"></i> Lista
            </a>

            <a href="{{ route('admin.conservationStatuses.edit', $conservationStatus) }}" class="btn btn-outline-warning">
        ...
        <div class="col-12 mb-3 mb-md-0">
            ...
            <div class="card h-100">
                ...
                <div class="card-body d-flex justify-content-center align-items-center p-2">
                    ...
                    <x-icon :entity="$conservationStatus" measure=200 shape=0 bgPresent=0 addClassesString="img-fluid zoom"></x-icon>
    ...
    <div class="card mb-2">
        ...
        <div class="card-body text-md-center">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-1">
                    <strong>ID</strong><br>
                    {{ $conservationStatus->id }}
                </div>

                <div class="col-md-2">
                    <strong>Slug</strong><br>
                    {{ $conservationStatus->slug }}
                </div>
                ...
                <div class="col-7 text-start text-md-center">
                    ...
                    {{ $conservationStatus->description ?: '-' }}
                </div>
