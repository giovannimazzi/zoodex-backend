...
<div class="container py-4">
    ...
    <h1 class="mb-2">Modifica Dieta</h1>

    <form action="{{ route('admin.diets.update', $diet) }}"
          method="POST"
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                ...
                @if ($diet->image)
                    ...
                    <x-icon :entity="$diet" measure=120 bgPresent=0 addClassesString="img-thumbnail mb-2 zoom"></x-icon>
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a href="{{ route('admin.diets.show', $diet) }}" class="btn btn-secondary">
                Annulla
            </a>
        </div>
