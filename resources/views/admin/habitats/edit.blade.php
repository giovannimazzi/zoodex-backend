...
<div class="container py-4">
    ...
    <h1 class="mb-2">Modifica Habitat</h1>

    <form action="{{ route('admin.habitats.update', $habitat) }}"
          method="POST"
                ...
                <div class="row g-2">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="description"
                                id="description"
                                rows="2"
                                class="form-control">{{ old('description', $habitat->description) }}</textarea>
                    </div>
        ...
        <div class="card mb-2">
            ...
            <div class="card-body">
                ...
                @if ($habitat->image)
                    ...
                    <x-icon :entity="$habitat" measure=120 bgPresent=0 addClassesString="img-thumbnail mb-2 zoom"></x-icon>
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a href="{{ route('admin.habitats.show', $habitat) }}" class="btn btn-secondary">
                Annulla
            </a>
        </div>
